...
public class GameLevel {
    ...
    public GameLevel(int level){
        ...
        if (level == 15){
            gridInfos = new GridOnBoardInfo[] {
                    new GridOnBoardInfo(6,11, 2, 1),
                    new GridOnBoardInfo(4,3, 6, 3),
                    new GridOnBoardInfo(7,7, 6, 2),
                    new GridOnBoardInfo(1,11, 6, 1)
            };

            pieceInfos = new PieceOnBoardInfo[] {

                    new PieceOnBoardInfo(12, true, 10, 1, 1),
                    new PieceOnBoardInfo(5, true, 10, 4, 2),
                    new PieceOnBoardInfo(7, true, 7, 6, 0),
